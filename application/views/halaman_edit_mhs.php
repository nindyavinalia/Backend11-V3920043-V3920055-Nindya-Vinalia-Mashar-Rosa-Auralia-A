	...
	<div class="col-md-6 offset-md-3">
		...
		<table>
			<tr>
				<td>ID</td>
				<td>:</td>
				<td><input type="text" name="id" value="<?php echo $queryMhsDetail->id ?>" readonly></td>
			</tr>
			<tr>
				<td>NIM</td>
				<td>:</td>
				<td><input type="text" name="nim" value="<?php echo $queryMhsDetail->nim ?>" ></td>
			</tr>
			<tr>
				<td>Nama</td>
				<td>:</td>
			...
			<tr>
				<td colspan="3"><button type="submit" class="btn btn-success">Update Data</button> | 
